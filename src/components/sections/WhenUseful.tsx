...
const WhenUseful = () => {
  ...
  const items = t('whenUseful.items', { returnObjects: true }) as string[]

  return (
    <section id="when-useful" className="py-20 md:py-32 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 text-center">
          {t('whenUseful.heading')}
        </h2>
