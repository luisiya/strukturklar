        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">{t('contact.name')}</h3>
              <p className="text-lg text-gray-600 mb-8">{t('contact.title')}</p>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 mb-8 border border-gray-100 shadow-sm">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="mailto:kontakt@strukturklar.com" className="text-gray-700 hover:text-primary-700 transition-colors">
                      kontakt@strukturklar.com
                    </a>
                  </div>
                </div>
              </div>
